...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/ram_reader_0/M_AXI" Clk "Auto" }  [get_bd_intf_pins ps_0/S_AXI_HP0]

apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Slave "/ps_0/S_AXI_HP0" Clk "Auto" }  [get_bd_intf_pins ram_writer_0/M_AXI]
